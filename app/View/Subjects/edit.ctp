                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Existing Class
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Existing Subject
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-4">
                                    <?php
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">New Subject Name<span class="required">
                                        * </span>
                                </label>
                                <div class="col-md-4">
                                    <?php
