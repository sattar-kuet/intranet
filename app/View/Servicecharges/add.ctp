            ...
            <div class="span12">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4>
                            <span>Add discount on service charge</span>
                        </h4>
                    ...
                    <div class="content">
                        <?php
                        echo $this->Form->create('ServiceCharge', array(
                            'inputDefaults' => array(
                                'label' => false,
                                'div' => false
                            ),
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">Discount on this quantity</label>
                                    <?php
                                    echo $this->Form->input(
                                            'discount', array(
                                        'id' => 'required',
