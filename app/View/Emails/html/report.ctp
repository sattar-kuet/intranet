          ...
          <td>
            <table class="table table-striped" style="color: #000; font-weight: bolder; border: 1px solid black !important;">
                            ...
                            <tr style="border: 1px solid black !important;">
                                ...
                                <td style="text-align: center;" rowspan="2"> 
                                  10  <?php //echo $total['totalSupport']; ?>
                                ...
                                <td style="text-align: center;">                                        
                                   10 <?php // echo $total['interruption'] ?>
                                </td>
                            ...
                            <tr style="border: 1px solid black !important;">
                                ...
                                <td style="text-align: center;"> 
                                    10<?php //echo $total['reconnection']; ?>
                                </td>  
                                ...
                                <td style="text-align: center;"> 
                                   10 <?php //echo $total['addsalesreceive']; ?> 
                                </td>  
                                ...
                                <td style="text-align: center;"> 
                                  10  <?php //echo $total['cancel_from_da']; ?>
                                </td>  
                                <td style="text-align: center;"> 
                                   10 <?php //echo $total['cancel_from_hold']; ?>
                                </td> 
                            </tr>   
                            ...
                            <tr style="border: 1px solid black !important;">
                                ...
                                <td style="text-align: center;"> 
                                   10 <?php // echo $total['totalAccount']; ?>
                                </td>  
                                ...
                                <td style="text-align: center;">                                        
                                  10  <?php //echo $total['cardinfotaken']; ?>
                                </td>  
                                <td style="text-align: center;"> 
                                    CHECK SEND
                                </td>  
                                ...
                                <td style="text-align: center;">                                        
                                   10 <?php //echo $total['online_payment'] ?>
                                </td>  
                                <td style="text-align: center;"> 
                                    SERVICE UNHOLD
                                </td>  
                                <td style="text-align: center;"> 
                                  10  <?php //echo $total['unhold'] ?>
                                </td> 
                                <td style="text-align: center;">
                                    OUT BOUND CALL                                           
                                    <hr style="width: 100%; height: 0px; margin: 0px; padding: 0px;">  
                                    10<?php //echo $total['totaloutbound']?>                                        
                                </td> 
                            </tr>
                        </table>
          </td>
