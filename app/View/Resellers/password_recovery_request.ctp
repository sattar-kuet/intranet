                    ...
                    <table class="body">
                        <tr>
                            <td class="center" align="center" valign="top">
                                ...
                                <a style="background: green; color: #FFF; padding: 4px 10px; border-radius: 7px;" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/reset/<?php echo $mail_content['key'] . 'BXX' . $mail_content['rand'] . 'XXB' . $mail_content['id']; ?>/">Click here to reset your account password</a>
                                <hr />
                                <p>Alternatively, you can also copy paste the below link into your browser:
                                </p>
                                <p>http://<?php echo $_SERVER['HTTP_HOST']; ?>/reset/<?php echo $mail_content['key'].'BXX' .$mail_content['rand'].'XXB'. $mail_content['id'];?>/</p>
                                <p>This email was sent by www.jegeachi.com </p>
                                <!-- END: Content -->
