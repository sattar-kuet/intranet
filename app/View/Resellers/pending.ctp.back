...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Pending reseller List <small> See the reseller and take necessary action</small>
        </h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-phone"></i>Pending Reseller
                        </div>
                                ...
                                foreach ($alldata as $k => $single):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a 
                                                onclick="if (confirm('Are you sure to approve this Reseller?' )) {
                                                        return true;
                                                        }
                                                        return false;"

                                                href="<?php
                                                echo Router::url(array('controller' => 'resellers', 'action' => 'approve', $reseller['id'])
                                                )
