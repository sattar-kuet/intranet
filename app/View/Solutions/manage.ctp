                           ...
                           <thead>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($solutions as $single):
                                                ...
                                                ?>
                                            <tr >
                                                <td><?php echo $solution['question']; ?></td>
                                                ...
                                                <td>   
                                                    <div class="controls center">
                                                        <a title="view" target="_blank" href="<?php echo Router::url(array('controller'=>'solutions','action'=>'edit',$solution['id']))?>" class="tip"><span class="fa  fa-eye"></span></a>
                                                        &nbsp;&nbsp;
                                                        ...
                                                        <?php if($solution['status'] == 'approved'):?>
                                                          ...
                                                          <a title="block" 
                                                           ...
                                                           href="<?php echo Router::url(array('controller'=>'solutions','action'=>'block',$solution['id'])
                                                        ...
                                                        onclick="if (confirm(&quot;Are you sure to approve this question?&quot;)) { return true; } return false;"
                                                           ...
                                                           href="<?php echo Router::url(array('controller'=>'solutions','action'=>'approve',$solution['id'])
                                                         )?>"
