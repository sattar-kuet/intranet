    ...
    <div id="sidebar">
        ...
        <div class="sidenav">
            ...
            <div class="mainnav">
                <ul>
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'employees', 'action' => 'dashboard')) ?>"><span class="icon16 icomoon-icon-home"></span>Home</a>
                    </li>
                    <li>
                        <a href="<?php echo Router::url(array('controller' => 'employees', 'action' => 'edit')) ?>"><span class="icon16 icomoon-icon-pencil"></span>Update Personal Info</a>
                    </li>
