            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" href="<?php echo Router::url(array('controller' => 'employees', 'action' => 'dashboard')) ?>">Employee Dashboard</a>
                        <div class="nav-no-collapse">
                            <ul class="nav pull-right usernav">
                                <li><a href="<?php echo Router::url(array('controller' => 'employees', 'action' => 'logout')) ?>"><span class="icon16 icomoon-icon-exit"></span> Logout</a></li>
                            </ul>
                        </div><!-- /.nav-collapse -->
                    </div>
                </div><!-- /navbar-inner -->
