   ...
   <div id="sidebar">
    ...
    <div class="sidenav">
        ...
        <div class="mainnav">
            <ul>
                <li>
                    <a href="#"><span class="icon16 typ-icon-users"></span>Duration Management</a>
                    <ul class="sub">
                        <li>
                            <a href="<?php echo Router::url(array('controller'=>'chunks','action'=>'setduration'))?>"><span class="icon16 icomoon-icon-plus"></span>Add Duration</a>
                        </li>
                     
                        <li>
                            <a href="<?php echo Router::url(array('controller'=>'chunks','action'=>'manageduration'))?>"><span class="icon16 wpzoom-settings"></span>Manage Duration</a>
                        </li>
