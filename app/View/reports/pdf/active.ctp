    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <a class="btn btn-lg blue hidden-print margin-bottom-5" target="_blank" onclick="javascript:window.print();">
        ...
        <div class="invoice">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <?php
                    echo $this->Html->link(__('Generate PDF Report'), array('action' => 'active', 'ext' => 'pdf'));
                    ?>
