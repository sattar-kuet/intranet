...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Approved review List <small> See the review and take necessary action</small>
        </h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-phone"></i>Approved review
                        </div>
                            ...
                            <tbody>
                                ...
                                foreach ($alldata as $k => $single):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a 
                                                onclick="if (confirm('Are you sure to deny this review?')) {
                                                    return true;
                                                    }
                                                    return false;"

                                                href="<?php
                                                echo Router::url(array('controller' => 'reviews', 'action' => 'deny', $review['id'])
                                                )
