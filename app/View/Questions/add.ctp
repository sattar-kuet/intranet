                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Board/University <span class="required">
                                        * </span>
                                </label>
                                <div class="col-md-4">
                                    <?php
                            ...
                            <div class="form-group" id="optionFormat">


                            </div>

                            <div class="form-group">
                                <label class="control-label col-md-3">Explanation <span class="required">
                                        * </span>
                                </label>
                                <div class="col-md-9">
                                    <?php
