                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <tbody>
                        ...
                        foreach ($data['allData'] as $results):
                            ...
                            $class = 'success';
                            if ($diff > 31536000 || empty($results['pc']['exp_date']) 
                                    || empty($results['pc']['exp_date']) || empty($results['pc']['r_duration']) 
                                    || $results['pc']['r_duration'] > 12 || empty($results['pc']['cfirst_name'])
                                    || empty($results['pc']['clast_name']) || empty($results['pc']['czip']) 
                                    || strlen($results['pc']['cvv_code']) != 3
                            ) {
                                $class = 'error';
                            }
                            ?>
