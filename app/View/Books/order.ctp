        ...
        foreach ($products as $count => $product):
            ...
            <div class="col-md-3 col-sm-4 col-xs-12" style="margin-left: -10px;">
                <div class="product-item">
                    ...
                    <h3><a href="shop-item.html" id ="p-info<?php echo $product['Product']['id']; ?>"><?php echo $product['Product']['name']; ?> -By <?php echo $product['Product']['writer']; ?> </a></h3>
                    <div class="pi-price">
                        <?php
            ...
            <div id="book-index<?php echo $product['Product']['id']; ?>" style="display: none; width: 700px;">
                <div class="product-page product-pop-up">
                    <?php echo $product['Psetting']['desc']; ?>
                </div>     
            </div>

            <div id="product-pop-up<?php echo $product['Product']['id']; ?>" style="display: none; width: 700px;">
                <div class="product-page product-pop-up">
                    <div class="row">
...
<div class="busket">
<div class="busket-head"> <span class="info">Service Charge : </span> <span class="sc">0</span> TK 
